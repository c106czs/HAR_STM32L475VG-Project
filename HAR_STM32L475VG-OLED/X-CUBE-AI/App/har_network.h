...
#ifndef __AI_HAR_NETWORK_H__
#define __AI_HAR_NETWORK_H__
#pragma once
...
#define AI_HAR_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 200, 6, 1, 1, NULL), \
}
#define AI_HAR_NETWORK_IN_SIZE { \
  (200 * 6 * 1), \
}
#define AI_HAR_NETWORK_IN_1_SIZE  (200 * 6 * 1)
#define AI_HAR_NETWORK_IN_1_SIZE_BYTES  ((200 * 6 * 1) * 4)




#define AI_HAR_NETWORK_OUT_NUM      (1)
...
#define AI_HAR_NETWORK_OUT_1_SIZE  (1 * 1 * 12)
#define AI_HAR_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 12) * 4)
