...
#define AI_NETWORK_HAR_MODEL_SIGNATURE     "2ea42701a0bbe3eb23959c7bcd734f8e"
...
#define AI_TOOLS_DATE_TIME   "Sat Aug 15 21:38:00 2020"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8,
                     1, 1, 36720, 1,
                     NULL),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NETWORK_HAR_IN_NUM, &input_1_output),
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NETWORK_HAR_OUT_NUM, &activation_4_output),
  ...
  ai_handle network, const ai_network_params* params)
{
  ...
  ai_bool ok = true;
  ok &= network_har_configure_weights(net_ctx, &params->params);
  ok &= network_har_configure_activations(net_ctx, &params->activations);
