...
#ifndef __AI_NETWORK_HAR_H__
#define __AI_NETWORK_HAR_H__
#pragma once
...
#define AI_NETWORK_HAR_IN_1_SIZE  (200 * 6 * 1)
#define AI_NETWORK_HAR_IN_1_SIZE_BYTES  ((200 * 6 * 1) * 4)
...
#define AI_NETWORK_HAR_OUT_1_SIZE  (1 * 1 * 12)
#define AI_NETWORK_HAR_OUT_1_SIZE_BYTES  ((1 * 1 * 12) * 4)
